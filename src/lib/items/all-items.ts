...
// import insuranceDeathStarIcon from "$lib/assets/images/item-icons/insurance-death-star.png";
...
export const allItems = new Map<string, Item>([
    ...
    // ["bureaucracy-bot", new BasicItem("Bureaucracy Bot 2000", 44000, 330000000, bureaucracyBotIcon)],
    ...
    // ["insurance-death-star", new BasicItem("Insurance Death Star", 510000000000000, 31000000000000000000000, insuranceDeathStarIcon)],
]);
